...
namespace ALG_POS_and_Inventory_Management_System
{
    ...
    public partial class frmVehicle : Form
    {
        ...
        {
            btnEdit.Enabled = false; btnSave.Enabled = true; vcledit = true; btnDelete.Enabled = false; VclUnLock(); txtCustID.Enabled = false;
        }
        ...
        {
            btnAdd.Enabled = false; btnSave.Enabled = true; VclUnLock(); vcladd = true; txtCustID.Enabled = false;
        }
    }
}

...
namespace ALG_POS_and_Inventory_Management_System {
    class ContInventorySuppliers {
        DbConnection Database = new DbConnection();
        public System.Data.DataTable LoadSuppliers() {
            try {
                string query = "SELECT supplier_ID, supplier_name, address, contact FROM suppliers WHERE date_deleted IS NULL";
                System.Data.DataTable dt = new System.Data.DataTable();
                dt = Database.Retrieve(query);
                return (dt);
            } catch (Exception ex) {
                System.Windows.Forms.MessageBox.Show("Error on populating suppliers listview: '" + ex + "'", "Suppliers", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Error);
                throw;
            }
        }

    ...
    class ContInventoryStocks {
        ...
        public System.Data.DataTable LoadStocks( string sort) {
            try {
                string query = "";
                if (sort == "Product ID")
                    query = "SELECT stock_ID,products.product_ID,product_name, CONCAT(product_name, 'DESC') ,total_stocks,remaining_stocks,DATE_FORMAT(received_date, '%m-%d-%Y'),supplier_name,supplier_price FROM products,stocks,suppliers WHERE stocks.product_ID=products.product_ID AND suppliers.supplier_ID=stocks.supplier_ID AND stocks.date_deleted IS NULL ORDER BY stocks.product_ID";
                else if (sort == "Product Name")
                    query = "SELECT stock_ID,products.product_ID,product_name, CONCAT(product_name, 'DESC') ,total_stocks,remaining_stocks,DATE_FORMAT(received_date, '%m-%d-%Y'),supplier_name,supplier_price FROM products,stocks,suppliers WHERE stocks.product_ID=products.product_ID AND suppliers.supplier_ID=stocks.supplier_ID AND stocks.date_deleted IS NULL ORDER BY product_name";
                else if (sort == "Stock ID")
                    query = "SELECT stock_ID,products.product_ID,product_name, CONCAT(product_name, 'DESC') ,total_stocks,remaining_stocks,DATE_FORMAT(received_date, '%m-%d-%Y'),supplier_name,supplier_price FROM products,stocks,suppliers WHERE stocks.product_ID=products.product_ID AND suppliers.supplier_ID=stocks.supplier_ID AND stocks.date_deleted IS NULL ORDER BY stock_ID";
                else if (sort == "Available Stock")
                    query = "SELECT stock_ID,products.product_ID,product_name, CONCAT(product_name, 'DESC') ,total_stocks,remaining_stocks,DATE_FORMAT(received_date, '%m-%d-%Y'),supplier_name,supplier_price FROM products,stocks,suppliers WHERE stocks.product_ID=products.product_ID AND suppliers.supplier_ID=stocks.supplier_ID AND stocks.date_deleted IS NULL ORDER BY stock_quantity";
                else if (sort == "Date - Desc")
                    query = "SELECT stock_ID,products.product_ID,product_name, CONCAT(product_name, 'DESC') ,total_stocks,remaining_stocks,DATE_FORMAT(received_date, '%m-%d-%Y'),supplier_name,supplier_price FROM products,stocks,suppliers WHERE stocks.product_ID=products.product_ID AND suppliers.supplier_ID=stocks.supplier_ID AND stocks.date_deleted IS NULL ORDER BY received_date DESC";
                else if (sort == "Date - Asc")
                    query = "SELECT stock_ID,products.product_ID,product_name, CONCAT(product_name, 'DESC') ,total_stocks,remaining_stocks,DATE_FORMAT(received_date, '%m-%d-%Y'),supplier_name,supplier_price FROM products,stocks,suppliers WHERE stocks.product_ID=products.product_ID AND suppliers.supplier_ID=stocks.supplier_ID AND stocks.date_deleted IS NULL ORDER BY received_date ASC";
                else
                    query = "SELECT stock_ID,products.product_ID,product_name, CONCAT(product_name, 'DESC') ,total_stocks,remaining_stocks,DATE_FORMAT(received_date, '%m-%d-%Y'),supplier_name,supplier_price FROM products,stocks,suppliers WHERE stocks.product_ID=products.product_ID AND suppliers.supplier_ID=stocks.supplier_ID AND stocks.date_deleted IS NULL";

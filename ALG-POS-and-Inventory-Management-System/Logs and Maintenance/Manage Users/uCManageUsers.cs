...
namespace ALG_POS_and_Inventory_Management_System {
    public partial class uCManageUsers : UserControl {
        ...
        {
            if (txtFN.Text.Trim() == "" || txtGN.Text.Trim() == "" || txtUN.Text.Trim() == "" || txtPW.Text.Trim() == "" || txtAddress.Text.Trim() == "")
            {
                MessageBox.Show("Please fill-up all fields", "User", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
            else
            {
                if (useradd)

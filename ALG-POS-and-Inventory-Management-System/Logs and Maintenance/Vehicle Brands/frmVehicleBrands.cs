...
namespace ALG_POS_and_Inventory_Management_System {
    public partial class frmVehicleBrands : Form {
        public frmVehicleBrands() {
            InitializeComponent();
        }

        ContVehicleBrands contBrands = new ContVehicleBrands();
        bool add = false, edit = false; string query; string tempOldName;

        private void frmVehicleBrands_Load(object sender, EventArgs e) {
            LoadLV();
        }
        ...
        private void LoadLV() {
            ...
            try {
                ...
                for (int i = 0; i < table.Rows.Count; i++) {
                    ...
                    listitem.SubItems.Add(dr["vehicle_brand_ID"].ToString());
